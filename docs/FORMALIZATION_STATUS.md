# Detailed formalization status

This document records the theorem-by-theorem status of the project at the beginning of Step 12. For the shorter project overview and build instructions, see the [main README](../README.md).
