...
This reference records the declarations and proof interfaces documented for
this branch. For the current overview and branch status, see the
[project README](../README.md). Detailed stage notes are available in
[this directory](.).
