...
A Lean 4 formalization of the local quantitative Theorem 1.2 and the
two-height counting estimate of Proposition 5.1 in Diego Marques's
...
The comparisons for [Theorem 1.2](docs/THEOREM_1_2.md) and
...
The complete local build and axiom audit passed for the
...
The formalization covers Proposition 5.1 and the local quantitative
Theorem 1.2. The entire-function consequence of Theorem 1.1, the independent
Section 7 results, and the general finite-smoothness version of the sublevel
theorem are outside this scope.
...
For reproducibility, cite the
[proof commit `babdfb8`](https://github.com/DiegoMarquesMath/MahlerLean/tree/babdfb81675dbce78991bef3cd8e9a4350635e1f),
which fixes the statements and proofs independently of later documentation changes.
